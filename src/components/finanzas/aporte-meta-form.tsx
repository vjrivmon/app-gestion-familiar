...
export function AporteMetaForm({
  open,
  onClose,
  meta,
  onAportar,
  ...
  const completaraLaMeta =
    nuevoTotal >= meta.objetivo && meta.actual < meta.objetivo;
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 pb-4 flex-shrink-0">
            ...
            <h2 className="text-lg font-semibold">
              Aportar a &ldquo;{meta.nombre}&rdquo;
            </h2>
