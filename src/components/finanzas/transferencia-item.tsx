...
export function TransferenciaItem({ 
  ...
  const getColor = (persona: Pagador): string => {
    switch (persona) {
      case 'm1': return 'text-blue-600 dark:text-blue-400'
      case 'm2': return 'text-pink-600 dark:text-pink-400'
      case 'conjunta': return 'text-purple-600 dark:text-purple-400'
    }
  }
